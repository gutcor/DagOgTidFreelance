...
<p class="field date nobr"><input id="id6345_text" type="text" name="endring.privat.fraDato" value="">
  ...
  <img alt="Velg en dag i kalenderen" src="./img/cal.gif" border="0" align="middle"></a>
      ...
      <div class="do-not-show">
          ...
          <div>
            <p class="name-help-name" style="display: none;">Gjer vel og rett opp førenamnet ditt.</p>
          </div>
          ...
          <div>
            <p class="name-help-lastname" style="display: none;">Gjer vel og rett opp etternamnet ditt.</p>
          </div>
          ...
          <div>
            <p class="name-help-address" style="display: none;">Gjer vel og rett opp gatenamnfeltet.</p>
          </div>
          ...
          <div>
            <p class="name-help-place" style="display: none;">Gjer vel og rett opp poststadfeltet.</p>
          </div>
          <p class="email">
  ...
  <div id="akseptfelt">
          <a href="http://dagogtid.com/tinging/bur-du-i-utlandet.php" class="utlandetMail" target="_top">Bur du i utlandet?</a>
...
<script type="text/javascript">
  ...
  if(formElem) {
    ...
    var url = "http://dagogtid.com/tinging/sommarkampanje.php?eksponering=vanlig";
